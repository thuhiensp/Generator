...
public class PonyTemplate {
  ...
  public CharSequence copyright() {
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Copyright 2019 SmartTrade Technologies");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*     Pony SDK");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("*");
    _builder.newLine();
  ...
  public String adjustJavaName(final String name) {
    String _xifexpression = null;
    boolean _contains = PonyTemplate.JAVA_RESERVED_KEYWORDS.contains(name);
    if (_contains) {
      _xifexpression = (name + "_");
    } else {
      _xifexpression = "P" + name;
    }
    return _xifexpression;
  }
  
  
  public String adjustJavaNameArg(final String name) {
	    String _xifexpression = null;
	    boolean _contains = PonyTemplate.JAVA_RESERVED_KEYWORDS.contains(name);
	    if (_contains) {
	      _xifexpression = (name + "_");
