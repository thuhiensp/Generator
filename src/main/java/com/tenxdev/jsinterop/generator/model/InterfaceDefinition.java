...
public class InterfaceDefinition extends AbstractDefinition implements HasUnionReturnTypes {
    ...
    public Set<String> setOfNamesAttrModifiable (){
    	Set<String> res = new HashSet<String>();
    	for (Attribute attr: attributes) {
    		if (!attr.isReadOnly() && !attr.isStatic()) {
    			res.add(attr.getType().getTypeName());
    		}
    	}
    	return res;
    }
    ...
    public List<Attribute> getAttributesModifiable(){
