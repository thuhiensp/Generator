...
import com.tenxdev.jsinterop.generator.pgenerator.PonySourceGenerator;
...
class PonyGenerator {
    ...
    private String basePackage = "com.ponysdk.core.ui2";
    ...
    public static void main(String[] args) {
        new PonyGenerator().execute(args);
    }
    ...
    private void processModel(Model model, Logger logger) throws IOException {
        ...
        new MethodUnionArgsExpander(model, logger).processModel(); //must run after all interface merging. hien test to import only attributes.
        ...
        //new NativeTypeArrayArgumentHandler(model, logger).process();// add some new constructor whose type of argument is Array in the case NativeType.
...
//                new Documentation();
        ...
        new PonySourceGenerator(logger).processModel(model,outputDirectory, basePackage, documentation);
    }
